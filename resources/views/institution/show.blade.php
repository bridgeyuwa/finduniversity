        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="table-alt">
                    ...
                    <table>
                        <thead>
                            <tr>
                                <th>Exam</th>
                                <th>Passing Rates (First Timers)</th>
                                <th>Rank in Philippines</th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <div class="map-holder">
                    ...
                    <div class="map">
                        <iframe width="600" height="450" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="./The Lyceum of the Philippines - Laguna _ FindUniversity.ph_files/maps.html"></iframe>
                    </div><!-- /.map -->
                </div><!-- /.map-holder -->
